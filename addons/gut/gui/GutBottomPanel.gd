...
func _apply_shortcuts():
	...
	_ctrls.run_at_cursor.get_script_button().shortcut = _ctrls.shortcut_dialog.get_run_current_script()
	_ctrls.run_at_cursor.get_inner_button().shortcut = _ctrls.shortcut_dialog.get_run_current_inner()
...
func load_result_output():
	...
	_ctrls.results.orphans.get_parent().visible = (
		...
		and !_gut_config.options.hide_orphans
	)
...
func set_interface(value):
	...
	_interface.get_script_editor().connect(
		"editor_script_changed", self, "_on_editor_script_changed"
	)
